...
class App:
    ...
    def check_link(self, page_progress_var, i, link, page_link, template, broken_links_report, link_cell, page_progress):
        ...
        if section == 'Footer' or \
            ...
            any(platform in page_link for platform in ['linkedin.com','facebook.com', 'twitter.com', 'youtube.com', 'instagram.com', 'tumblr.com', 'pinterest.com']):
            return
        ...
        try:
            ...
            try:
                ...
                response = http.request('GET', url, headers=headers, timeout=3.0)
